<template>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="text-dark float-start">{{title}}</h5>
                        </div>
                        <div class="col-md-6">
                            <button @click="createTask" class="btn btn-success btn-sm float-end">Add Task</button>
                        </div>
                    </div>
                </div>
    ...
    <div :class="`modal-dialog modal-dialog-centered ${!deleteMode ? 'modal-lg' : 'modal-sm'}`">
        ...
        <div class="modal-body">
            <div class="row" v-show="!deleteMode">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="text-danger" v-show="taskErrors.title">Title is empty!!!</span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="text-danger" v-show="taskErrors.date">Date is empty!!!</span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <span class="text-danger" v-show="taskErrors.time">Time is empty!!!</span>
                    </div>
                </div>
            </div>
            <div class="row" v-show="!deleteMode">
            ...
            <h5 class="text-center" v-show="deleteMode">Want to Delete this task?</h5>
        </div>
